...
Since we spend every day with our product, product managers tend to have a lot of pride in what the team has built, "It slices, it dices, it makes julienne fries!" Most users won't care about your product as much as you do. They probably wish they didn't need it at all. They are willing to spend money beacause it's better than solving the problem on their own. Whatever that problem is, they care most about the outcome that it provides, and how easily they can access that value. (And that it's durable, secure, and supportable.) 

When we communicate our roadmap externally it's important, in as few words as possible, to describe what the users will get out of the product, rather than describe what the product is. If you are having trouble narrowing it down, think about one or two use cases that people are doing now, or at least what your anchor customers plan to do with the feature. It's ok if you don't explain all of the possibilities of a feature in a roadmap. People will figure it out. For now, just make sure that people get a gist for what the feature is _for_. They'll figure out the rest later, or you can fill in the gaps with continued product marketing.

Try to avoid sharing a roadmap slide by itself. Without context, a single slide doesn't accomplish much, unless it's included in an overview deck along with dozens of other similarly-formatted slides. Instead, I try to create a short slide deck which facilitates a roadmap discussion.

> I once took over as director of engineering for a service where the founders had selected all of the infrastructure themselves. Our team was having terrible trouble with the storage arrays, which the founders had selected because they had excellent ATA over Ethernet performance. For months we struggled with their support till I escalated. "We're running some of the Internet's most popular services on your storage, but we're not getting the performance we expect." To my surprise, they were dismayed, "You want low-latency performance for high performance websites? We've been positioning our product as a tape library alternative. We do care about performance, but totally different than what you care about."
